# # Модель массового обслуживания M/M/2
#
# Дискретно-событийное моделирование системы с двумя каналами.
# Входящий поток — пуассоновский, обслуживание — экспоненциальное.
#
# Параметры:
# - λ = 0.9 (интенсивность входящего потока)
# - μ = 0.5 (интенсивность обслуживания одного канала)
# - c = 2 (количество каналов)
# - num_customers = 1000 (количество заявок)
