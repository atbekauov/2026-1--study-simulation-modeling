...
#
# Исследование чувствительности модели SIR к изменению
# коэффициента заражения β при фиксированном γ.
...
# ### Запуск симуляций для каждого β
...
# ### График: пик I и конечное R от β
