...
# 
# Анализирует влияние интенсивности перемещений между городами на динамику эпидемии.
...
# Создаёт матрицу вероятностей миграции.
...
# Запускает симуляцию и возвращает время и величину пика.
