# # Сканирование коэф-а заразности β
# Исследуем, как изменнение базовой заразности влияет на ключевые показатели эпидемии
using DrWatson
...
# ## Диапазон значений и список параметров
# Для каждого значения beta выполняется 3 прогона с разными seed.
