# # Параметрическое исследование комплексной динамики
# 
# Скрипт выполняет серию симуляций с различными параметрами модели
# (максимальный возраст, начальная доля белых) и для каждой комбинации
# строит комплексные графики динамики численности, температуры и светимости.
# 
